...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'partypi.com'
  config.app_name = 'Partypi'
  config.mailer.from = 'Partypi <no-reply@partypi.com>'
  ...
  #
  config.app_secret = 'SoYLIGvleGxw1aL7mwJowG8q49QjI7Wj_SLf-30Z2SFC9dGJ25JTJG38bbTa1obnoVE'
